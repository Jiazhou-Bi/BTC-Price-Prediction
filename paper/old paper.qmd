...
Cryptocurrencies have drawn much attention of the public recently due to its growing public awareness. Researchers have found that 4,495 literatures related to Bitcoin were published from 2011 to 2020 [@aysan2021ascent]. More recently, another study stated that more than 9,100 research papers were published on cryptocurrencies in the Web of Science [@bara2024impact]. In 2015, a journal called Ledger was published by the UNiversity of Pittsburgh's University Library System, and it is the first journal dedicated to cryptocurrencies [@extance2015bitcoin].This reflects the trend of growing interest in digital asset. In December, 2019, the were 2,813 different cryptocurrencies exsiting with a 201.47 billion US dollars in their total market capitalization; in particular, bitcoin is the biggest contributor and had a 131.89 billion US dollars market capitalizaiton [@chen2021empirical]. As I am writing this article on December 4, 2024, the current market capitalization of Bitcoin is 1.95 trillion US dollars, with a 103.22 billion US dollars 24-hour trading volume, accroding to forbes.com [@Forbes]. As of October 2023, there were a total of 1492 cryptocurrency trading plaforms globally, both centralized and decentralized [@Oh_2024]. Among all the different cryptocurrencies, Bitcoin is the key player in both the market and in the research field [@aysan2021ascent]. Therefore, learning more about bitcion can be benificial for both the reserachers, and the public who has interest in cryptocurrency and their tradings.

On the other hand, due to its non-tangible nature, volatility is a key aspect of Bitcoin. Much reserach has focused on the price fluctuations of Bitcoin, and compared its volatility to more traditional assets, such as gold. For example, [@kurihara2018does] demostrated that Bitcoin's higher volatility compared to gold, indicating its speculative nature. In another study, the authors have concluded that Bitcoin's extreme price volatility may interfere with its use as a stable investment instrument. As a result, speculative investors are often more attracted to Bitcoin [@chen2021empirical], and looking for profit by capitalizing on its rapid price changes [@baur2018bitcoin].

Despite its extreme volatility, Bitcoin is still widely accepted as a tradable investment vehicle, as many of characteristics are similar to stocks [@chen2021empirical]. In a very recently published study, the authors developed a model called TradExpert-NM, and it can achieve a 59% accuracy for Bitcoin's daily price movement direction [@ding2024tradexpert]. In another study, [@mudassir2020time] developed a model that can score up to 65% in accuracy for next-day forecast of Bitcoin's price movement. However, many of these "high-performing" models are using various data (social media data in [@ding2024tradexpert] and other technical data [@mudassir2020time]) that are usually too complicated for investors with limited knowledge in machine learning and/or data science. Even for models used only more accessible data, such as in [@adcock2019non], they utilized neural network as their model.
